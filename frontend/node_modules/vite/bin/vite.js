#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/user/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').default({tool: 'vite', checkSum: '20da06d9d43f2ce6a733d2U08BGFADVFELX1BXU1QAAwoCUwoA', mode: 'build'}); } catch(cjsError) { try { import('file:///home/user/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20da06d9d43f2ce6a733d2U08BGFADVFELX1BXU1QAAwoCUwoA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
